...
final public class Preferences implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static Boolean getAutoProcNoti() {
        String key = Application.getStringResource(R.string.pref_key_auto_proc_noti);
        boolean defaultValue = Boolean.parseBoolean(Application.getStringResource(R.string.pref_def_value_auto_proc_noti));
        return Application.getSharedPreferences().getBoolean(key, defaultValue);
    }

    public static Boolean getHttpsReqLogs() {
        String key = Application.getStringResource(R.string.pref_key_https_req_logs);
        boolean defaultValue = Boolean.parseBoolean(Application.getStringResource(R.string.pref_def_value_https_req_logs));
        return Application.getSharedPreferences().getBoolean(key, defaultValue);
    }
