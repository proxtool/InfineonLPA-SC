...
import com.infineon.esim.lpa.core.es9plus.FileUtil;
...
final public class ProfileListActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if(Preferences.getHttpsReqLogs()) FileUtil.init(this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_settings) {
            ...
            return true;
        } else if(id == R.id.action_switch_euicc) {
            viewModel.switchEuicc();
            return true;
            ...
            return true;
        } else if(id == R.id.action_proc_notifications) {
            // Process eUICC notifications
            viewModel.handleAllNotifications();
            return true;
        } else if(id == R.id.action_clear_notifications) {
            // Clear eUICC notifications (enable/disable)
    ...
    final Observer<AsyncActionStatus> actionStatusObserver = actionStatus -> {
        ...
        switch (actionStatus.getActionStatus()) {
            ...
            case HANDLE_ALL_NOTIFICATIONS_STARTED: {
                progressDialog = DialogHelper.showProgressDialog(this, R.string.action_handling_notifications);
                disallowBackButtonPress();
                break;
            }
            ...
            case CLEAR_NOTIFICATIONS_FINISHED:
            case HANDLE_ALL_NOTIFICATIONS_FINISHED: {
