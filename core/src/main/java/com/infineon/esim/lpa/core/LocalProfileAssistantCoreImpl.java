...
import com.infineon.esim.lpa.core.worker.local.ClearNotificationsWorker;
...
public class LocalProfileAssistantCoreImpl implements LocalProfileAssistantCore {
    ...
    public ClearNotificationsResult clearPendingNotifications() throws Exception {
        ...
        List<Integer> resultValues = new ClearNotificationsWorker(es10Interface).clearNotifications();
